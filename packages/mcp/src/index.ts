...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  switch (name) {
    ...
    case 'delete_project': {
      const deleted = await deleteProject(args?.project_id as string);
      return jsonContent({ action: 'deleted_project', project_id: args?.project_id, deleted });
    }
    ...
    case 'delete_epic': {
      ...
      return jsonContent({ action: 'deleted_epic', epic_id: args?.epic_id, deleted: true });
    }
    ...
    case 'update_task': {
      ...
      return jsonContent({ action: 'updated_task', task: { ...task, blocked: await isTaskBlocked(task.id) } });
    }
    ...
    case 'delete_task': {
      ...
      return jsonContent({ action: 'deleted_task', task_id: args?.task_id, deleted: true });
    }
    ...
    case 'delete_task_comment': {
      ...
      return jsonContent({ action: 'deleted_task_comment', task_id: args?.task_id, comment_id: args?.comment_id, deleted: true });
    }
    ...
    case 'delete_webhook': {
      ...
      return jsonContent({ action: 'deleted_webhook', webhook_id: args?.webhook_id, deleted: true });
    }
